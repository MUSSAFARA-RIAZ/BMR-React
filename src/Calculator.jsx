...
const BMRcal=()=>{
  ...
  return (
   ...
   <input type="text" placeholder='Enter your weight' id="weight"onChange={InputWeight} />
   <label htmlFor="height">Height</label>
   <input type="text" placeholder='Enter Your height' id="height" onChange={InputHeight}/>    
   <label >Age</label>
